use ingestion_core::zeek_parser::{conn_log, dns_log, http_log, ssl_log};
...
#empty_field\t(empty)\n\
#unset_field\t-\n\
#fields\tts\tuid\tid.orig_h\tid.orig_p\tid.resp_h\tid.resp_p\tproto\tservice\tduration\torig_bytes\tresp_bytes\tconn_state\torig_pkts\tresp_pkts\torig_ip_bytes\tresp_ip_bytes\n\
...
fn parses_conn_log() {
    ...
    assert_eq!(recs[0].orig_ip_bytes, 1674);
